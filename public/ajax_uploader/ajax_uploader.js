...
(function($){
 	...
 	$.fn.extend({ 
		...
		ajax_uploader_tools: function() {
			var self = this[0];
			
			return {
				cancel: function(fileId) {
					self._ajax_uploader._handler.cancel(fileId);
				}
			};
		},

 		ajax_uploader: function(options) {
			...
			this[0]._ajax_uploader = new ajax_uploader(this[0],default_options);
		}
...
ajax_uploader_helper = {}

ajax_uploader_helper.getUniqueId = (function(){
    var id = 0;
    ...
    */
ajax_uploader_helper.toElement = (function(){
...
ajax_uploader_helper.indexOf = function(arr, elt, from){
...
ajax_uploader_helper.obj2url = function(obj, temp, prefixDone){
    var uristrings = [],
        prefix = '&',
            ...
            if ((nextTemp != 'undefined') && (i != 'undefined')) {  
                uristrings.push(
                    (typeof nextObj === 'object') 
                        ? ajax_uploader_helper.obj2url(nextObj, nextTemp, true)
    ...
    if (!prefixDone && temp) {
      ...
      uristrings.push(ajax_uploader_helper.obj2url(obj));
...
ajax_uploader = function(button,options) {
...
qq.UploadHandlerAbstract.prototype = {
    ...
    _dequeue: function(id){
        var i = ajax_uploader_helper.indexOf(this._queue, id);
...
$.extend(qq.UploadHandlerForm.prototype, {
    add: function(fileInput){
        ...
        var id = 'qq-upload-handler-iframe' + ajax_uploader_helper.getUniqueId();       
    ...
    _createIframe: function(id){
	    ...
	    var iframe = ajax_uploader_helper.toElement('<iframe src="javascript:false;" name="' + id + '" />');
    ...
    _createForm: function(iframe, params){
	    ...
	    var form = ajax_uploader_helper.toElement('<form method="post" enctype="multipart/form-data"></form>');
	

        var queryString = ajax_uploader_helper.obj2url(params, this._options.action);
